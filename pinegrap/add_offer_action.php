...
if (!$_POST) {
    ...
    print
    pg_page_shell([
        'title'=> lang('Create Offer Action'),
        'extra classes'=>'products',
        'icon'=>'store',
        'heading'=>lang('Create Offer Action'),
        'cancel'=>array('enable'=>'true','url'=>'view_offer_actions.php')
    ,
            'breadcrumb' => array(array('label' => lang('All Offer Actions'), 'url' => OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/view_offer_actions.php'), array('label' => lang('Create Offer Action'))),
        ]) . '
            <div class="row">
            <div class="col-12">
                <div class="row mb-2  flex-wrap">
                    <div class="col-12 col-sm-12 text-center text-md-start">
<h2 class="d-inline-block text-break header-content-for-add-page" data-bs-content="' . lang('Create a new offer action that can be assigned to any offer.') . '" title="' . lang('Create Offer Action') . '">[' . lang('Offer Action Name') . ']</h2>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                            <div class="card my-4 position-sticky" style="top:56px;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <select name="type" id="type" class="form-select collapse-if-selected" data-bs-target="#offer_action_options_row" onchange="change_offer_action_type(this.options[this.selectedIndex].value)"><option value="">-' . lang(array('string'=>'Select {var:1}','vars'=>array(lang('type')) )) . '-</option>' . select_offer_action_type() . '</select></select>
                                            <script>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-lg-6 col-xl-3 my-2">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control add-header-content-updater"/>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row collapse" id="discount_order">
                                            ...
                                            <div class="col-12 col-md-auto my-2">
                                                ...
                                                <input type="text" name="discount_order_percentage" id="discount_order_percentage" class="form-control" style="min-width:100px" maxlength="8" inputmode="numeric" data-inputmask-alias="percentage"  data-inputmask-digits="2" data-inputmask-digitsOptional="false" data-inputmask-placeholder="0"  style="text-align: right;" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row collapse" id="discount_product">
                                            ...
                                            <div class="col-12 my-2">
                                                ...
                                                <select name="discount_product_product_id" id="discount_product_product_id" class="select2 form-select w-auto" data-placeholder="' . lang('Click to select product(s)') . '"><option value="">-' . lang(array('string'=>'Select {var:1}','vars'=>array(lang('product')) )) . '-</option>' . select_product() . '</select>
                                            </div>
                                            <div class="col-12 col-md-auto my-2">
                                                <label for="discount_product_amount" class="form-label">' . lang('Amount') . '</label>
                                                <div class="input-group">
                                                    <input type="text" name="discount_product_amount" id="discount_product_amount" class="form-control" style="min-width:100px" maxlength="12" inputmode="numeric" data-inputmask-alias="currency" data-inputmask-groupSeparator="," data-inputmask-digits="2" data-inputmask-digitsOptional="false" data-inputmask-placeholder="0"  style="text-align: right;" />
                                                    <span class="input-group-text">' . BASE_CURRENCY_SYMBOL . '</span>
                                                </div>
                                            </div>
                                            <div class="col-12 my-2">
                                            ...
                                            <div class="col-12 col-md-auto my-2">
                                                ...
                                                <input type="text" name="discount_product_percentage" id="discount_product_percentage" class="form-control" style="min-width:100px" maxlength="8" inputmode="numeric" data-inputmask-alias="percentage"  data-inputmask-digits="2" data-inputmask-digitsOptional="false" data-inputmask-placeholder="0"  style="text-align: right;" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row collapse" id="add_product">
                                            ...
                                            <div class="col-12 col-lg-8 my-2">
                                                ...
                                                <select name="add_product_product_id" id="add_product_product_id" class="select2 form-select w-auto" data-placeholder="' . lang('Click to select product(s)') . '"><option value="">-' . lang(array('string'=>'Select {var:1}','vars'=>array(lang('product')) )) . '-</option>' . select_product() . '</select>
                                            </div>
                                            <div class="col-12 col-lg-4 my-2">
                                                ...
                                                <div class="input-group number-controls">
                                                    ...
                                                    <input class="form-control text-center border-start-0 border-end-0" value="" type="text" name="add_product_quantity" id="add_product_quantity" maxlength="9" inputmode="numeric" data-inputmask-alias="decimal"  data-inputmask-placeholder="0"/>
                                            ...
                                            <div class="col-12 col-md-auto my-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="add_product_discount_amount" id="add_product_discount_amount" class="form-control" style="min-width:100px" maxlength="12" inputmode="numeric" data-inputmask-alias="currency" data-inputmask-groupSeparator="," data-inputmask-digits="2" data-inputmask-digitsOptional="false" data-inputmask-placeholder="0"  style="text-align: right;" />
                                                    <span class="input-group-text">' . BASE_CURRENCY_SYMBOL . '</span>
                                                </div>
                                            </div>
                                            <div class="col-12 my-2">
                                        ...
                                        <div class="row collapse" id="discount_shipping">
                                            ...
                                            <div class="col-12 col-md-auto my-2">
                                                ...
                                                <input type="text" name="discount_shipping_percentage" id="discount_shipping_percentage" class="form-control" style="min-width:100px" maxlength="8" inputmode="numeric" data-inputmask-alias="percentage"  data-inputmask-digits="2" data-inputmask-digitsOptional="false" data-inputmask-placeholder="0"  style="text-align: right;" />
                                            </div>
    ...
    log_activity(lang(array('string'=>'offer action ({var:1}) was created','vars'=>$_POST['name'])), $_SESSION['sessionusername']);
