        ...
        <div class="col-12">
            ...
            <div class="row mb-2  flex-wrap">
                <div class="col-12 col-sm-12 col-md-6 col-xl-8 text-center text-md-start">
                    <h2 class="d-inline-block " data-bs-content="' . lang('View the number of Products that need to be shipped or have been shipped on different days.') . '" title="' . lang('Shipping Report') . '">' . lang('Shipping Report') . '</h2>
