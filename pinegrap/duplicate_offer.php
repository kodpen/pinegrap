...
log_activity(lang(array('string'=>'offer ({var:1}) was duplicated','vars'=>$original_code)), $_SESSION['sessionusername']);

$liveform->add_notice(lang('The offer has been duplicated, and you are now editing the duplicate.'));
