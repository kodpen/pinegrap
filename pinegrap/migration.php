            ...
            <div class="col-12">
                ...
                <div class="row mb-2  flex-wrap">
                    <div class="col-12 col-sm-12 text-center text-md-start">
                        <h2 class="d-inline-block text-break header-content-for-add-page" data-bs-content="' . lang('Copy items from a source site to this site.') . '" title="' . lang('Migration') . '">' . lang('Migration') . '</h2>
                    </div>
                </div>
